...
@app.route('/')
def home():
    return render_template('home.html', predicted=False)
...
def predict():
    ...
    return render_template("home.html", prediction_text = "The predicted house price is {}".format(output), predicted=True)
